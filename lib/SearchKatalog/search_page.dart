  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.pink, // Warna background page
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Colors.pink, // Warna tulisan judul
                  ),
                ),
              ),
              Row(
                ...
                children: <Widget>[
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: Colors.pink, // Warna tulisan Select Category
                    ),
                  ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Colors.pink, // Warna dropdown background
                    ),
                    child: DropdownButton<String>(
                      ...
                      items: <String>['Author', 'Title', 'Age']
                        ...
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value, style: TextStyle(color: Colors.black)), // Warna dropdown item
                        );
                      }).toList(),
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      primary: Colors.pink, // Warna tombol Search
